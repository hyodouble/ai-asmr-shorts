...
- 영상 생성 툴: Kling AI 가입 대기 중 (결제 포함이라 본인이 직접)
- 제작한 영상: 0편
- 다음 단계: 핸들·배너·설명 정리 → Kling 가입 → 클립 5개로 루프 파이프라인 검증 → 40개 양산 → 1시간 1편 업로드
...
4. 영상 생성 자체는 Kling 등에서 하고, MCP가 연결돼 있으면 그 단계도 클로드가 호출
